                ...
                '<div class="dh-notify-wrap">' +
                    ...
                    '<div class="dh-notify-dropdown" id="dhNotifyDropdown">' +
                        ...
                        '<div class="dn-scroll">' +
                            ...
                            '<!-- 能量不足 -->' +
                            '<div class="notify-item unread" data-category="revenue"><div class="revenue-row"><div class="notify-icon avatar"><img src="https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?auto=format&fit=crop&w=200&q=80" alt=""></div><div class="notify-content"><div class="revenue-title">角色管理</div><div class="notify-desc"><strong>赵无极</strong> 能量不足，尽快补充能量或停用</div><div class="revenue-amount">当前能量 <span style="color:#f59e0b">0</span></div><div class="notify-meta">28分钟前</div></div><button class="rev-act-btn" onclick="location.href=\'studio.html\'">补充</button></div><div class="notify-footer"><button class="notify-more" onclick="dhToggleDelete(event,this)">···</button><div class="delete-dropdown"><button class="delete-btn" onclick="dhDeleteNotify(event,this)">删除</button></div></div></div>' +
                            '<!-- 激活收益到账 -->' +
